                                    ...
                                    <div class="nk-block-head nk-block-head-lg">
                                        <div class="nk-block-between-md g-4">
                                            <div class="nk-block-head-content">
                                                <h2 class="nk-block-title fw-normal">Bienvenidos al cine</h2>
                                                <div class="nk-block-des">
                                                    <p>Gestiona tu cine desde aqui</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                                ...
                                                <div class="card card-bordered card-full">
                                                    <div class="nk-wg1">
                                                        ...
                                                        <div class="nk-wg1-action">
                                                            <a href="html/subscription/profile.html" class="link"><span>Peliculas</span> <em class="icon ni ni-chevron-right"></em></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- .col -->
                                                ...
                                                <div class="card card-bordered card-full">
                                                    <div class="nk-wg1">
                                                        <div class="nk-wg1-block">
                                                            ...
                                                            <div class="nk-wg1-text">
                                                                <h5 class="title">Actores</h5>
                                                                <p>Listar, añadir y modificar actores</p>
                                                            </div>
                                                        </div>
                                                        <div class="nk-wg1-action">
                                                            <a href="html/subscription/profile-setting.html" class="link"><span>Actores</span> <em class="icon ni ni-chevron-right"></em></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- .col -->
                                            <div class="col-md-6">
                                                <div class="card card-bordered card-full">
                                                    <div class="nk-wg1">
                                                        ...
                                                        <div class="nk-wg1-action">
                                                            <a href="html/subscription/payments.html" class="link"><span>Usuarios</span> <em class="icon ni ni-chevron-right"></em></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- .col -->
                                                    ...
                                                    <div class="nk-wg1">
                                                        <div class="nk-wg1-block">
                                                            ...
                                                            <div class="nk-wg1-text">
                                                                ...
                                                                <p>Listar añadir o modificar salas</p>
                                                            </div>
                                                        </div>
                                                        <div class="nk-wg1-action">
