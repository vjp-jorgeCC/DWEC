...
<a href="index.php" class="text-green-600 text-5xl pl-[15px] text-transparent relative top-36">Inicio</a>
    <div class="bg-[url('./../../../utils/img/maquetar/fondoRegistro.png')] bg-no-repeat bg-center w-[1500px] h-[665px] m-auto">
        <div class="w-[500px] h-[592px] relative top-[40px] m-auto bg-white/[.2]" action="index.php?ctl=anadirPeli">
            <form method="POST" action="index.php?ctl=anadirPersonal" enctype="multipart/form-data">
                <h2 class="font-[600] text-3xl text-white pt-16 pl-[90px] pb-[10px]">Añadir actores y directores</h2>
                <label  class="pl-[90px]" for="nombre"></label>
                <input  class="mb-2 bg-[#020510] opacity-70 text-white pl-[10px] font-[400] text-lg w-[300px] h-[55px]" type="text" id="nombre" name="nombre" value="Nombre" ><br>
