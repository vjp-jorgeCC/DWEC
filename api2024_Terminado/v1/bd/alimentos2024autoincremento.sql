...
VALUES (1, 'Pan blanco', 74, 3, 14, 1, 1, 'panBlanco.png'),
(2, 'Pan integral', 65, 3, 9, 7, 1, 'panIntegral.png'),
(3, 'Azúcar', 150, 34, 34, 0, 123, 'azucar.png'),
(4, 'refresco', 136, 36, 35, 0, 0, 'refresco.png'),
(5, 'Huevo', 156, 13, 13, 0, 12, 'huevo.png'),
(6, 'pizza', 1234, 11, 1111, 1, 1111, 'pizza.png'),
(7, 'pastel', 2111, 11, 111, 0, 1111, 'pastel.png'),
(
        8,
        'hamburguesa',
        11111,
...
(11, 'calamar', 234, 12, 12, 12, 12, 'calamar.png'),
